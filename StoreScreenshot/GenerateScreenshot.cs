...
public class GenerateScreenshot : MonoBehaviour
{
    ...
    [HideInInspector] public bool hideCanvases, saveAsJpg;
    [HideInInspector] public int jpgQuality;
    ...
    IEnumerator TimedScreenshot()
    {
        ...
        for (int i = 0; i < resolutions.Count; i++)
        {
            ...
            {
                StoreScreenshotUtils.AddCustomSize(resolutions[i].width, resolutions[i].height,
                    "StoreScreenshot_" + resolutions[i].resName);
                StoreScreenshotUtils.ChangeGameViewSize(resolutions[i].width, resolutions[i].height,
                    "StoreScreenshot_" + resolutions[i].resName);
